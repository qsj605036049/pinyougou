                    ...
                    <div id="specification" class="summary-wrap clearfix">
                        ...
                        <#list specList as spec>
                            <dl>
                                ...
                                <dd><a href="javascript:;" ng-click="updateSelected('${spec.attributeName}','${value}')" class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}">${value}<span title="点击取消选择">&nbsp;</span>
                                    </a></dd>
                                </#list>
                            </dl>
                        </#list>
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a ng-click="addCart(${item.id},num)" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
